...
def check_repository(version):
    ...
    while current_minor >= 1:
        ...
        try:
            subprocess.run(['sudo', 'dnf', '-v', 'repository-packages', repository, 'info', 'cri-o'], check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
